...
export class WyvernExchangeV2 extends ethereum.SmartContract {
  static bind(address: Address): WyvernExchangeV2 {
    return new WyvernExchangeV2("WyvernExchangeV2", address);
  }
